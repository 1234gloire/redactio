...
.brand-mark-text{font-family:var(--serif);font-style:italic;font-weight:600;font-size:1.08rem;letter-spacing:-1px;line-height:1;color:#fff;transform:translate(-1px,1px)}
...
<header class="nav">
 <div class="wrap nav-inner">
   <a class="brand" href="#top" aria-label="REDACTIO accueil">
    <span class="brand-mark" aria-hidden="true"><span class="brand-mark-text">Rd</span></span>     <span><span class="brand-name">REDACTIO</span><span class="brand-sub">Rédaction hospitalière</span></span>
   </a>
