...
<section class="band" id="demo"><div class="wrap"><div class="demo reveal"><div><span class="eyebrow">Établissements</span><h2 style="margin-top:.6em">Parlons de votre service.</h2><p>Une démonstration de 30 minutes, adaptée à votre activité (MCO, SSR/SMR, psychiatrie…) et à vos enjeux QLS.</p><ul class="demo-pts"><li><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24"><path d="M20 6 9 17l-5-5"/></svg> Cas d'usage sur vos propres types de courriers</li><li><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24"><path d="M20 6 9 17l-5-5"/></svg> Réponse à vos questions sécurité &amp; conformité</li><li><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24"><path d="M20 6 9 17l-5-5"/></svg> Proposition de pilote sur un service</li></ul></div><div class="form"><div class="frow"><div class="field"><label for="f-nom">Nom</label><input id="f-nom" type="text" placeholder="Dr Martin"></div><div class="field"><label for="f-fonction">Fonction</label><input id="f-fonction" type="text" placeholder="Chef de service, DIM, DSI…"></div></div><div class="frow"><div class="field full"><label for="f-etab">Établissement</label><input id="f-etab" type="text" placeholder="CH / CHU / Clinique / GHT"></div></div><div class="frow"><div class="field"><label for="f-mail">E-mail professionnel</label><input id="f-mail" type="email" placeholder="nom@etablissement.fr"></div><div class="field"><label for="f-taille">Praticiens concernés</label><select id="f-taille"><option>1 à 10</option><option>10 à 50</option><option>50 à 200</option><option>200+</option></select></div></div><div class="field full"><label for="f-msg">Votre besoin (facultatif)</label><textarea id="f-msg" rows="3" placeholder="Type de courriers, volumétrie, échéances…"></textarea></div><button type="button" class="btn btn-slate">Demander une démonstration</button><p class="form-note">Formulaire de démonstration — à connecter à votre CRM / e-mail. Aucune donnée patient ici.</p></div></div></div></section>
