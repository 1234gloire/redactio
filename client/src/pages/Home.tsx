...
const landingStyles = `
@import url('https://fonts.googleapis.com/css2?family=Spectral:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Hanken+Grotesk:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;500&display=swap');
.redactio-landing{--ink:#0C1E2E;--slate:#1E3A5F;--soin:#0E9C8E;--soin-deep:#0A7B70;--paper:#FBFAF8;--bg:#fff;--mist:#EEF3F5;--mist-deep:#E2EAEE;--line:#D9E2E7;--line-soft:#E8EEF1;--seal:#C58A12;--muted:#5A6B78;--muted-light:#8497A2;--serif:'Spectral',Georgia,serif;--sans:'Hanken Grotesk',system-ui,-apple-system,sans-serif;--mono:'JetBrains Mono',monospace;color:var(--ink);background:var(--bg);font-family:var(--sans);line-height:1.55;-webkit-font-smoothing:antialiased;overflow-x:hidden}
.redactio-landing *{box-sizing:border-box}.redactio-landing a{color:inherit;text-decoration:none}.lp-wrap{max-width:1180px;margin:0 auto;padding:0 28px}.lp-nav{position:sticky;top:0;z-index:60;background:rgba(255,255,255,.84);backdrop-filter:blur(14px);border-bottom:1px solid var(--line-soft)}.lp-nav-inner{height:70px;display:flex;align-items:center;justify-content:space-between;gap:24px}.lp-brand{display:flex;align-items:center;gap:.7em}.lp-brand-mark{width:38px;height:38px;border-radius:9px;background:var(--slate);display:grid;place-items:center;color:#fff;flex-shrink:0}.lp-brand-name{display:block;font-weight:800;letter-spacing:.04em;font-size:1.05rem;line-height:1}.lp-brand-sub{display:block;font-family:var(--mono);font-size:.62rem;letter-spacing:.12em;color:var(--muted);text-transform:uppercase;margin-top:3px}.lp-links{display:flex;align-items:center;gap:1.8rem}.lp-links a{font-size:.92rem;font-weight:500;color:var(--muted)}.lp-links a:hover{color:var(--ink)}.lp-nav-cta{display:flex;align-items:center;gap:.9rem}.lp-login{font-size:.92rem;font-weight:600}.lp-menu{display:none;background:none;border:0;color:var(--ink)}
.lp-btn{display:inline-flex;align-items:center;justify-content:center;gap:.5em;font-weight:600;font-size:.95rem;padding:.78em 1.35em;border-radius:10px;border:0;white-space:nowrap;transition:transform .18s ease,box-shadow .25s ease,background .2s ease;cursor:pointer}.lp-btn-primary{background:var(--soin);color:#fff;box-shadow:0 8px 22px -10px rgba(14,156,142,.7)}.lp-btn-primary:hover{background:var(--soin-deep);transform:translateY(-2px)}.lp-btn-slate{background:var(--slate);color:#fff}.lp-btn-slate:hover{background:var(--ink);transform:translateY(-2px)}.lp-btn-ghost{background:transparent;color:var(--ink);border:1.5px solid var(--line)}.lp-btn-ghost:hover{border-color:var(--slate);background:var(--mist)}.lp-btn-light{background:#fff;color:var(--slate)}.lp-arr{transition:transform .18s}.lp-btn:hover .lp-arr{transform:translateX(3px)}
.lp-hero{background:linear-gradient(180deg,var(--bg) 0%,var(--paper) 100%);padding:60px 0 92px;overflow:hidden}.lp-hero-grid{display:grid;grid-template-columns:1.04fr .96fr;gap:54px;align-items:center}.lp-segment{display:inline-flex;background:var(--mist);border:1px solid var(--line);border-radius:12px;padding:4px;gap:4px;margin-bottom:24px}.lp-segment button{font-weight:600;font-size:.86rem;border:0;background:transparent;color:var(--muted);padding:.55em 1em;border-radius:9px;cursor:pointer;display:flex;align-items:center;gap:.5em}.lp-segment button[aria-selected=true]{background:#fff;color:var(--ink);box-shadow:0 2px 8px -3px rgba(12,30,46,.25)}.lp-hero h1{font-family:var(--serif);font-weight:600;font-size:clamp(2.2rem,4.3vw,3.4rem);line-height:1.09;letter-spacing:0;margin:0 0 .4em}.lp-hero h1 em{font-style:italic;color:var(--soin-deep)}.lp-hero-lead{font-size:1.12rem;color:var(--muted);max-width:40ch;margin-bottom:1.6em;min-height:3.4em}.lp-hero-actions{display:flex;gap:.8rem;flex-wrap:wrap;margin-bottom:1.5em}.lp-trust{display:flex;gap:1.3rem;flex-wrap:wrap;font-size:.83rem;color:var(--muted);font-weight:500}.lp-trust span{display:inline-flex;align-items:center;gap:.45em}.lp-trust svg{color:var(--soin)}
.lp-doc-card{background:#fff;border:1px solid var(--line);border-radius:14px;box-shadow:0 30px 70px -38px rgba(12,30,46,.4);overflow:hidden}.lp-doc-head{display:flex;align-items:center;gap:.6em;padding:.85em 1.1em;border-bottom:1px solid var(--line-soft);background:var(--mist)}.lp-doc-head span{width:9px;height:9px;border-radius:50%;background:var(--line)}.lp-doc-head .live{background:var(--soin)}.lp-doc-head b{font-family:var(--mono);font-size:.72rem;letter-spacing:.08em;color:var(--muted);text-transform:uppercase;margin-left:.3em}.lp-doc-body{display:grid;grid-template-columns:1fr 1fr}.lp-doc-pane{padding:1.05em 1.15em;min-height:330px}.lp-raw{background:var(--ink);color:#C7D3DC;border-right:1px solid var(--line-soft)}.lp-pane-tag{font-family:var(--mono);font-size:.64rem;letter-spacing:.13em;text-transform:uppercase;margin-bottom:.9em;display:block}.lp-raw .lp-pane-tag{color:#6E8290}.lp-raw p{font-family:var(--mono);font-size:.78rem;line-height:1.75;color:#9FB1BD}.lp-raw b{color:#E6EDF1;font-weight:500}.lp-out{background:var(--paper)}.lp-out .lp-pane-tag,.lp-doc-section div{color:var(--soin-deep)}.lp-doc-section{margin-bottom:.85em}.lp-doc-section div{font-weight:700;font-size:.66rem;letter-spacing:.06em;text-transform:uppercase;margin-bottom:.15em}.lp-doc-section p{font-family:var(--serif);font-size:.85rem;line-height:1.4;color:var(--ink)}.lp-seal{display:inline-flex;align-items:center;gap:.45em;margin-top:.4em;font-weight:600;font-size:.72rem;color:var(--seal)}
.lp-strip{border-top:1px solid var(--line-soft);border-bottom:1px solid var(--line-soft);background:#fff}.lp-strip-inner{display:flex;flex-wrap:wrap}.lp-strip-item{flex:1 1 220px;padding:24px;border-right:1px solid var(--line-soft);display:flex;gap:.85em;align-items:flex-start}.lp-strip-item:last-child{border-right:0}.lp-strip-item>span{width:34px;height:34px;border-radius:8px;background:var(--mist);display:grid;place-items:center;color:var(--soin-deep);flex-shrink:0}.lp-strip-item b{font-weight:700;font-size:.92rem;line-height:1.2}.lp-strip-item p{font-size:.8rem;color:var(--muted);margin-top:2px}
.lp-band{padding:92px 0}.lp-mist{background:var(--mist)}.lp-paper{background:var(--paper)}.lp-section-head{max-width:56ch;margin-bottom:46px}.lp-section-head.center{margin-left:auto;margin-right:auto;text-align:center}.lp-eyebrow{font-family:var(--mono);font-size:.72rem;letter-spacing:.16em;text-transform:uppercase;color:var(--soin-deep);font-weight:500;display:inline-flex;align-items:center;gap:.55em}.lp-eyebrow:before{content:"";width:18px;height:1.5px;background:var(--soin);display:inline-block}.lp-eyebrow.light{color:#9CDCD2}.lp-eyebrow.light:before{background:#9CDCD2}.lp-section-head h2,.lp-etab h2,.lp-secure h2,.lp-demo h2,.lp-final h2{font-family:var(--serif);font-weight:600;font-size:clamp(1.7rem,3vw,2.4rem);line-height:1.14;letter-spacing:0;margin:.45em 0 .35em}.lp-section-head p{color:var(--muted);font-size:1.05rem}
.lp-product-grid,.lp-feature-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:22px}.lp-product,.lp-feature,.lp-plan{background:#fff;border:1px solid var(--line);border-radius:14px;padding:30px 26px 26px;position:relative}.lp-product:before{content:"";position:absolute;top:0;left:0;right:0;height:3px;background:var(--accent)}.lp-product:hover,.lp-door:hover{transform:translateY(-4px);box-shadow:0 24px 50px -28px rgba(12,30,46,.3)}.lp-product-icon{width:46px;height:46px;border-radius:11px;display:grid;place-items:center;color:#fff;background:var(--accent);margin-bottom:20px}.lp-product h3,.lp-feature h4,.lp-door h3,.lp-plan h3{font-family:var(--serif);font-weight:600;font-size:1.22rem;margin-bottom:.35em}.lp-product p,.lp-feature p,.lp-plan p,.lp-door p{font-size:.92rem;color:var(--muted);margin-bottom:1.1em}.lp-product ul,.lp-plan ul{list-style:none;margin:0 0 1.3em;padding:0}.lp-product li,.lp-plan li{display:flex;gap:.55em;padding:.28em 0;align-items:flex-start;font-size:.83rem}.lp-product li:before{content:"";width:6px;height:6px;border-radius:2px;background:var(--accent);margin-top:.5em;flex-shrink:0}.lp-tag{font-family:var(--mono);font-size:.64rem;letter-spacing:.06em;text-transform:uppercase;color:var(--accent-deep);background:var(--mist);border-radius:6px;padding:.3em .6em}
.lp-steps{display:grid;grid-template-columns:repeat(3,1fr);gap:0}.lp-step{padding:0 30px;border-left:1px solid var(--line)}.lp-step:first-child{padding-left:0;border-left:0}.lp-step span,.lp-plan>span:first-child,.lp-door>span{font-family:var(--mono);font-size:.7rem;letter-spacing:.12em;text-transform:uppercase;color:var(--soin-deep)}.lp-step h3{font-family:var(--serif);font-weight:600;font-size:1.3rem;margin:.5em 0 .4em}.lp-step p{color:var(--muted);font-size:.93rem}.lp-step kbd{display:inline-block;margin-top:1em;font-family:var(--mono);font-size:.74rem;background:#fff;border:1px solid var(--line);border-radius:7px;padding:.4em .7em}
.lp-doors,.lp-plans{display:grid;grid-template-columns:1fr 1fr;gap:18px}.lp-door{border-radius:14px;padding:30px;border:1px solid var(--line);transition:transform .2s,box-shadow .25s}.lp-door-prat{background:linear-gradient(180deg,#fff,#E7F4F2)}.lp-door-etab{background:linear-gradient(180deg,#fff,var(--mist-deep))}.lp-door-etab>span{color:var(--slate)}.lp-door b{display:inline-flex;align-items:center;gap:.45em;color:var(--soin-deep)}.lp-door-etab b{color:var(--slate)}.lp-mt{margin-top:34px}.lp-feature div{width:42px;height:42px;border-radius:10px;background:#E7F4F2;color:var(--soin-deep);display:grid;place-items:center;margin-bottom:14px}.lp-feature.dark{background:rgba(255,255,255,.04);border-color:rgba(255,255,255,.1)}.lp-feature.dark div{background:transparent;color:#5FD3C6}.lp-feature.dark h4{color:#fff}.lp-feature.dark p{color:#94A9B8}
.lp-etab,.lp-secure{background:var(--ink);color:#D6E0E8}.lp-etab h2,.lp-secure h2{color:#fff;max-width:24ch}.lp-etab-lead,.lp-secure>div>p{color:#9FB4C2;font-size:1.06rem;max-width:52ch}.lp-reg{display:flex;gap:1em;align-items:flex-start;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-left:3px solid #5FD3C6;border-radius:12px;padding:22px 24px;margin:34px 0 12px}.lp-reg svg{color:#5FD3C6}.lp-reg h4{color:#fff;font-size:1.02rem;margin-bottom:.3em}.lp-reg p{color:#94A9B8;font-size:.9rem}.lp-etab-grid,.lp-secure-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-top:32px}.lp-etab-grid{grid-template-columns:repeat(2,1fr)}.lp-cta-row{display:flex;gap:.8rem;flex-wrap:wrap;margin-top:34px}.lp-btn-dark-ghost{color:#D6E0E8;border:1px solid rgba(255,255,255,.25);background:transparent}.lp-disclaimer{font-size:.78rem;color:#7E96A8;margin-top:26px;max-width:74ch}
.lp-plans{max-width:880px;margin:0 auto}.lp-plan.featured{border-color:var(--slate);box-shadow:0 24px 50px -30px rgba(30,58,95,.4)}.lp-badge{position:absolute;top:-11px;right:24px;background:var(--slate);color:#fff;font-size:.68rem;font-family:var(--mono);letter-spacing:.08em;text-transform:uppercase;padding:.35em .8em;border-radius:999px}.lp-plan li svg{color:var(--soin);flex-shrink:0;margin-top:3px}.lp-plan .lp-btn{width:100%}
.lp-demo{display:grid;grid-template-columns:.9fr 1.1fr;gap:48px;align-items:center;background:var(--mist);border:1px solid var(--line);border-radius:20px;padding:44px}.lp-demo p{color:var(--muted);font-size:.98rem;margin-bottom:1em}.lp-demo ul{list-style:none;padding:0}.lp-demo li{display:flex;gap:.55em;align-items:center;padding:.3em 0}.lp-demo li svg{color:var(--soin)}.lp-form{background:#fff;border:1px solid var(--line);border-radius:14px;padding:26px}.lp-form-row{display:grid;grid-template-columns:1fr 1fr;gap:14px}.lp-form label{display:flex;flex-direction:column;gap:.35em;margin-bottom:14px}.lp-form span{font-size:.78rem;font-weight:600;color:var(--ink)}.lp-form input,.lp-form select,.lp-form textarea{font:inherit;font-size:.9rem;padding:.7em .8em;border:1px solid var(--line);border-radius:9px;background:var(--paper);color:var(--ink);width:100%}.lp-form .lp-btn{width:100%}.lp-form p{font-size:.72rem;color:var(--muted-light);margin-top:10px;text-align:center}
.lp-final-band{padding-top:0}.lp-final{background:var(--slate);color:#fff;border-radius:20px;padding:56px;text-align:center}.lp-final h2{color:#fff;max-width:22ch;margin-left:auto;margin-right:auto}.lp-final p{color:#B9C9D6;font-size:1.04rem;margin:0 auto 1.8em;max-width:46ch}.lp-final>div{display:flex;gap:.8rem;justify-content:center;flex-wrap:wrap}.lp-footer{background:var(--paper);border-top:1px solid var(--line);padding:54px 0 38px}.lp-foot-grid{display:grid;grid-template-columns:1.6fr 1fr 1fr 1fr;gap:34px;margin-bottom:38px}.lp-foot-grid p{font-size:.86rem;color:var(--muted);max-width:30ch;margin-top:14px}.lp-foot-col h5{font-size:.72rem;letter-spacing:.1em;text-transform:uppercase;color:var(--muted-light);font-family:var(--mono);margin-bottom:14px;font-weight:500}.lp-foot-col a{display:block;font-size:.9rem;padding:.3em 0}.lp-foot-bar{border-top:1px solid var(--line);padding-top:22px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px;font-size:.8rem;color:var(--muted)}
@media(max-width:900px){.lp-hero-grid,.lp-product-grid,.lp-feature-grid,.lp-etab-grid,.lp-secure-grid,.lp-doors,.lp-plans,.lp-demo{grid-template-columns:1fr}.lp-links{display:none}.lp-menu{display:block}.lp-steps{grid-template-columns:1fr;gap:32px}.lp-step{border-left:2px solid var(--line);padding:0 0 0 18px}.lp-step:first-child{padding-left:18px;border-left:2px solid var(--line)}.lp-foot-grid{grid-template-columns:1fr 1fr}.lp-strip-item{flex:1 1 100%;border-right:0;border-bottom:1px solid var(--line-soft)}}@media(max-width:520px){.lp-wrap{padding:0 20px}.lp-doc-body,.lp-form-row{grid-template-columns:1fr}.lp-raw{border-right:0;border-bottom:1px solid rgba(255,255,255,.08)}.lp-doc-pane{min-height:0}.lp-final,.lp-demo,.lp-plan{padding:30px 24px}.lp-nav-cta .lp-btn,.lp-login{display:none}}
.redactio-landing :focus-visible{outline:2px solid var(--soin);outline-offset:3px;border-radius:4px}
`;
