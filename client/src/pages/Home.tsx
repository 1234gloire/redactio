...
.redactio-landing{--ink:#0C1717;--panel:#152322;--panel-2:#213130;--border:#253736;--text:#EFF5F5;--muted:#8AA8A7;--muted-strong:#DFECEB;--accent:#3ECCC4;--accent-2:#7CE7DF;--amber:#F59F0A;--green:#279B65;--violet:#7C3AED;--surface:rgba(21,35,34,.82);--surface-soft:rgba(33,49,48,.72);--sans:'Inter',system-ui,-apple-system,sans-serif;--display:'Space Grotesk',system-ui,-apple-system,sans-serif;--mono:'JetBrains Mono',monospace;color:var(--text);background:var(--ink);font-family:var(--sans);line-height:1.55;-webkit-font-smoothing:antialiased;overflow-x:hidden}
.redactio-landing *{box-sizing:border-box}.redactio-landing a{color:inherit;text-decoration:none}.lp-wrap{max-width:1180px;margin:0 auto;padding:0 28px}.lp-nav{position:sticky;top:0;z-index:60;background:rgba(12,23,23,.86);backdrop-filter:blur(16px);border-bottom:1px solid var(--border)}.lp-nav-inner{height:70px;display:flex;align-items:center;justify-content:space-between;gap:24px}.lp-brand{display:flex;align-items:center;gap:.7em}.lp-brand-mark{width:38px;height:38px;border-radius:11px;background:linear-gradient(135deg,var(--accent),#6ee7df);display:grid;place-items:center;color:#0C1717;flex-shrink:0;box-shadow:0 0 0 1px rgba(239,245,245,.08),0 16px 34px -24px var(--accent)}.lp-brand-name{display:block;font-family:var(--display);font-weight:800;letter-spacing:.04em;font-size:1.05rem;line-height:1;color:var(--text)}.lp-brand-sub{display:block;font-family:var(--mono);font-size:.58rem;letter-spacing:.14em;color:var(--muted);text-transform:uppercase;margin-top:4px}.lp-links{display:flex;align-items:center;gap:1.8rem}.lp-links a{font-size:.92rem;font-weight:500;color:var(--muted)}.lp-links a:hover{color:var(--text)}.lp-nav-cta{display:flex;align-items:center;gap:.9rem}.lp-login{font-size:.92rem;font-weight:700;color:var(--text)}.lp-menu{display:none;background:none;border:0;color:var(--text)}
.lp-btn{display:inline-flex;align-items:center;justify-content:center;gap:.5em;font-weight:700;font-size:.95rem;padding:.86em 1.45em;border-radius:999px;border:1px solid transparent;white-space:nowrap;transition:transform .18s ease,box-shadow .25s ease,background .2s ease,border-color .2s ease;cursor:pointer}.lp-btn-primary{background:var(--accent);color:#fff;box-shadow:0 20px 46px -24px rgba(62,204,196,.9)}.lp-btn-primary:hover{background:var(--accent-2);color:#0C1717;transform:translateY(-2px)}.lp-btn-slate{background:var(--panel-2);border-color:var(--border);color:var(--text)}.lp-btn-slate:hover{border-color:rgba(62,204,196,.55);background:#263d3b;transform:translateY(-2px)}.lp-btn-ghost,.lp-btn-dark-ghost{background:rgba(21,35,34,.58);color:var(--text);border-color:var(--border)}.lp-btn-ghost:hover,.lp-btn-dark-ghost:hover{border-color:rgba(62,204,196,.55);background:rgba(62,204,196,.1)}.lp-btn-light{background:var(--text);color:#0C1717}.lp-arr{transition:transform .18s}.lp-btn:hover .lp-arr{transform:translateX(3px)}
.lp-hero{background:radial-gradient(circle at 78% 8%,rgba(62,204,196,.16),transparent 34%),linear-gradient(180deg,#0C1717 0%,#101f1e 100%);padding:72px 0 98px;overflow:hidden}.lp-hero-grid{display:grid;grid-template-columns:1.04fr .96fr;gap:54px;align-items:center}.lp-segment{display:inline-flex;background:rgba(33,49,48,.72);border:1px solid var(--border);border-radius:999px;padding:4px;gap:4px;margin-bottom:28px}.lp-segment button{font-weight:700;font-size:.86rem;border:0;background:transparent;color:var(--muted);padding:.62em 1.05em;border-radius:999px;cursor:pointer;display:flex;align-items:center;gap:.5em}.lp-segment button[aria-selected=true]{background:var(--accent);color:#0C1717;box-shadow:0 12px 26px -20px rgba(62,204,196,.9)}.lp-hero h1{font-family:var(--display);font-weight:700;font-size:clamp(2.65rem,5.6vw,4.55rem);line-height:1.02;letter-spacing:0;margin:0 0 .38em;color:var(--text)}.lp-hero h1 em{font-style:normal;color:var(--accent-2)}.lp-hero-lead{font-size:1.12rem;color:var(--muted-strong);max-width:44ch;margin-bottom:1.7em;min-height:3.4em}.lp-hero-actions{display:flex;gap:1rem;flex-wrap:wrap;margin-bottom:1.5em}.lp-trust{display:flex;gap:1.3rem;flex-wrap:wrap;font-size:.84rem;color:var(--muted);font-weight:600}.lp-trust span{display:inline-flex;align-items:center;gap:.45em}.lp-trust svg{color:var(--accent)}
.lp-doc-card{background:var(--panel);border:1px solid var(--border);border-radius:18px;box-shadow:0 34px 74px -36px rgba(0,0,0,.76);overflow:hidden}.lp-doc-head{display:flex;align-items:center;gap:.6em;padding:.9em 1.15em;border-bottom:1px solid var(--border);background:var(--panel-2)}.lp-doc-head span{width:9px;height:9px;border-radius:50%;background:#365351}.lp-doc-head .live{background:var(--accent)}.lp-doc-head b{font-family:var(--mono);font-size:.7rem;letter-spacing:.12em;color:var(--muted);text-transform:uppercase;margin-left:.3em}.lp-doc-body{display:grid;grid-template-columns:1fr 1fr}.lp-doc-pane{padding:1.1em 1.15em;min-height:330px}.lp-raw{background:#101C1C;color:#C7D3DC;border-right:1px solid var(--border)}.lp-pane-tag{font-family:var(--mono);font-size:.64rem;letter-spacing:.14em;text-transform:uppercase;margin-bottom:.9em;display:block;color:var(--muted)}.lp-raw p{font-family:var(--mono);font-size:.78rem;line-height:1.75;color:#9FB1BD}.lp-raw b{color:var(--text);font-weight:600}.lp-out{background:#EFF8F7;color:#0C1717}.lp-out .lp-pane-tag,.lp-doc-section div{color:#0A7B70}.lp-doc-section{margin-bottom:.85em}.lp-doc-section div{font-weight:800;font-size:.66rem;letter-spacing:.06em;text-transform:uppercase;margin-bottom:.15em}.lp-doc-section p{font-family:var(--sans);font-size:.85rem;line-height:1.5;color:#0C1717}.lp-seal{display:inline-flex;align-items:center;gap:.45em;margin-top:.4em;font-weight:700;font-size:.72rem;color:#A36B05}
.lp-strip{border-top:1px solid var(--border);border-bottom:1px solid var(--border);background:#101C1C}.lp-strip-inner{display:flex;flex-wrap:wrap}.lp-strip-item{flex:1 1 220px;padding:24px;border-right:1px solid var(--border);display:flex;gap:.85em;align-items:flex-start}.lp-strip-item:last-child{border-right:0}.lp-strip-item>span{width:34px;height:34px;border-radius:10px;background:rgba(62,204,196,.1);display:grid;place-items:center;color:var(--accent);flex-shrink:0}.lp-strip-item b{font-weight:800;font-size:.92rem;line-height:1.2;color:var(--text)}.lp-strip-item p{font-size:.8rem;color:var(--muted);margin-top:2px}
.lp-band{padding:92px 0;background:var(--ink)}.lp-mist,.lp-paper{background:#101C1C}.lp-section-head{max-width:58ch;margin-bottom:46px}.lp-section-head.center{margin-left:auto;margin-right:auto;text-align:center}.lp-eyebrow{font-family:var(--mono);font-size:.72rem;letter-spacing:.16em;text-transform:uppercase;color:var(--accent-2);font-weight:600;display:inline-flex;align-items:center;gap:.55em}.lp-eyebrow:before{content:"";width:18px;height:1.5px;background:var(--accent);display:inline-block}.lp-eyebrow.light{color:var(--accent-2)}.lp-eyebrow.light:before{background:var(--accent)}.lp-section-head h2,.lp-etab h2,.lp-secure h2,.lp-demo h2,.lp-final h2{font-family:var(--display);font-weight:700;font-size:clamp(2rem,3.6vw,3rem);line-height:1.08;letter-spacing:0;margin:.45em 0 .35em;color:var(--text)}.lp-section-head p{color:var(--muted);font-size:1.05rem}
.lp-product-grid,.lp-feature-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:22px}.lp-product,.lp-feature,.lp-plan{background:var(--surface);border:1px solid var(--border);border-radius:18px;padding:30px 26px 26px;position:relative}.lp-product:before{content:"";position:absolute;top:0;left:0;right:0;height:3px;background:var(--accent)}.lp-product:hover,.lp-door:hover{transform:translateY(-4px);box-shadow:0 24px 50px -28px rgba(0,0,0,.7);border-color:rgba(62,204,196,.35)}.lp-product-icon{width:46px;height:46px;border-radius:13px;display:grid;place-items:center;color:#0C1717;background:var(--accent);margin-bottom:20px}.lp-product h3,.lp-feature h4,.lp-door h3,.lp-plan h3{font-family:var(--display);font-weight:700;font-size:1.22rem;margin-bottom:.35em;color:var(--text)}.lp-product p,.lp-feature p,.lp-plan p,.lp-door p{font-size:.92rem;color:var(--muted);margin-bottom:1.1em}.lp-product ul,.lp-plan ul{list-style:none;margin:0 0 1.3em;padding:0}.lp-product li,.lp-plan li{display:flex;gap:.55em;padding:.28em 0;align-items:flex-start;font-size:.83rem;color:var(--muted-strong)}.lp-product li:before{content:"";width:6px;height:6px;border-radius:2px;background:var(--accent);margin-top:.5em;flex-shrink:0}.lp-tag{font-family:var(--mono);font-size:.64rem;letter-spacing:.06em;text-transform:uppercase;color:var(--accent-deep);background:rgba(62,204,196,.08);border:1px solid rgba(62,204,196,.2);border-radius:999px;padding:.35em .7em}
.lp-steps{display:grid;grid-template-columns:repeat(3,1fr);gap:0}.lp-step{padding:0 30px;border-left:1px solid var(--border)}.lp-step:first-child{padding-left:0;border-left:0}.lp-step span,.lp-plan>span:first-child,.lp-door>span{font-family:var(--mono);font-size:.7rem;letter-spacing:.12em;text-transform:uppercase;color:var(--accent-2)}.lp-step h3{font-family:var(--display);font-weight:700;font-size:1.3rem;margin:.5em 0 .4em;color:var(--text)}.lp-step p{color:var(--muted);font-size:.93rem}.lp-step kbd{display:inline-block;margin-top:1em;font-family:var(--mono);font-size:.74rem;background:var(--panel);border:1px solid var(--border);border-radius:999px;padding:.45em .75em;color:var(--muted-strong)}
.lp-doors,.lp-plans{display:grid;grid-template-columns:1fr 1fr;gap:18px}.lp-door{border-radius:18px;padding:30px;border:1px solid var(--border);background:var(--surface);transition:transform .2s,box-shadow .25s,border-color .2s}.lp-door-prat{background:linear-gradient(180deg,rgba(62,204,196,.1),rgba(21,35,34,.82))}.lp-door-etab{background:linear-gradient(180deg,rgba(245,159,10,.1),rgba(21,35,34,.82))}.lp-door-etab>span{color:#FFD48A}.lp-door b{display:inline-flex;align-items:center;gap:.45em;color:var(--accent-2)}.lp-door-etab b{color:#FFD48A}.lp-mt{margin-top:34px}.lp-feature div{width:42px;height:42px;border-radius:12px;background:rgba(62,204,196,.1);color:var(--accent);display:grid;place-items:center;margin-bottom:14px}.lp-feature.dark{background:rgba(255,255,255,.04);border-color:rgba(255,255,255,.1)}.lp-feature.dark div{background:transparent;color:var(--accent)}.lp-feature.dark h4{color:#fff}.lp-feature.dark p{color:var(--muted)}
.lp-etab,.lp-secure{background:#0C1717;color:var(--muted-strong)}.lp-etab h2,.lp-secure h2{color:#fff;max-width:24ch}.lp-etab-lead,.lp-secure>div>p{color:var(--muted);font-size:1.06rem;max-width:52ch}.lp-reg{display:flex;gap:1em;align-items:flex-start;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-left:3px solid var(--accent);border-radius:16px;padding:22px 24px;margin:34px 0 12px}.lp-reg svg{color:var(--accent)}.lp-reg h4{color:#fff;font-size:1.02rem;margin-bottom:.3em}.lp-reg p{color:var(--muted);font-size:.9rem}.lp-etab-grid,.lp-secure-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-top:32px}.lp-etab-grid{grid-template-columns:repeat(2,1fr)}.lp-cta-row{display:flex;gap:.8rem;flex-wrap:wrap;margin-top:34px}.lp-disclaimer{font-size:.78rem;color:var(--muted);margin-top:26px;max-width:74ch}
.lp-plans{max-width:880px;margin:0 auto}.lp-plan.featured{border-color:rgba(62,204,196,.55);box-shadow:0 24px 50px -30px rgba(62,204,196,.45)}.lp-badge{position:absolute;top:-11px;right:24px;background:var(--accent);color:#0C1717;font-size:.68rem;font-family:var(--mono);font-weight:700;letter-spacing:.08em;text-transform:uppercase;padding:.4em .9em;border-radius:999px}.lp-plan li svg{color:var(--accent);flex-shrink:0;margin-top:3px}.lp-plan .lp-btn{width:100%}
.lp-demo{display:grid;grid-template-columns:.9fr 1.1fr;gap:48px;align-items:center;background:var(--surface);border:1px solid var(--border);border-radius:22px;padding:44px}.lp-demo p{color:var(--muted);font-size:.98rem;margin-bottom:1em}.lp-demo ul{list-style:none;padding:0}.lp-demo li{display:flex;gap:.55em;align-items:center;padding:.3em 0;color:var(--muted-strong)}.lp-demo li svg{color:var(--accent)}.lp-form{background:#0F1D1C;border:1px solid var(--border);border-radius:18px;padding:26px}.lp-form-row{display:grid;grid-template-columns:1fr 1fr;gap:14px}.lp-form label{display:flex;flex-direction:column;gap:.35em;margin-bottom:14px}.lp-form span{font-size:.78rem;font-weight:700;color:var(--text)}.lp-form input,.lp-form select,.lp-form textarea{font:inherit;font-size:.9rem;padding:.78em .85em;border:1px solid var(--border);border-radius:12px;background:#101C1C;color:var(--text);width:100%}.lp-form input::placeholder,.lp-form textarea::placeholder{color:rgba(138,168,167,.72)}.lp-form .lp-btn{width:100%}.lp-form p{font-size:.72rem;color:var(--muted);margin-top:10px;text-align:center}
.lp-final-band{padding-top:0}.lp-final{background:linear-gradient(135deg,rgba(62,204,196,.16),rgba(33,49,48,.92));border:1px solid var(--border);color:#fff;border-radius:22px;padding:56px;text-align:center}.lp-final h2{color:#fff;max-width:22ch;margin-left:auto;margin-right:auto}.lp-final p{color:var(--muted-strong);font-size:1.04rem;margin:0 auto 1.8em;max-width:46ch}.lp-final>div{display:flex;gap:.8rem;justify-content:center;flex-wrap:wrap}.lp-footer{background:#101C1C;border-top:1px solid var(--border);padding:54px 0 38px}.lp-foot-grid{display:grid;grid-template-columns:1.6fr 1fr 1fr 1fr;gap:34px;margin-bottom:38px}.lp-foot-grid p{font-size:.86rem;color:var(--muted);max-width:30ch;margin-top:14px}.lp-foot-col h5{font-size:.72rem;letter-spacing:.1em;text-transform:uppercase;color:var(--muted);font-family:var(--mono);margin-bottom:14px;font-weight:600}.lp-foot-col a{display:block;font-size:.9rem;padding:.3em 0;color:var(--muted-strong)}.lp-foot-bar{border-top:1px solid var(--border);padding-top:22px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:10px;font-size:.8rem;color:var(--muted)}
